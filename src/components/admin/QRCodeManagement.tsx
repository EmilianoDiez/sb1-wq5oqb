        ...
        <div className="space-y-6">
          <div className="bg-blue-50 rounded-lg p-4">
            ...
            <ul className="text-sm text-blue-700 space-y-2">
              ...
              <li>• Debe ser escaneado junto con el DNI en la entrada</li>
              <li>• Solo funciona para afiliados y acompañantes autorizados</li>
              <li>• Se recomienda regenerar el código diariamente</li>
            </ul>
          </div>
